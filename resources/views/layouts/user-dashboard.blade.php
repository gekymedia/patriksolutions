    ...
    <div class="dashboard-wrapper">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="sidebar-menu">
                ...
                <a href="{{ route('budget_calculator.index') }}" class="sidebar-menu-item {{ request()->routeIs('budget_calculator.index') ? 'active' : '' }}" style="padding-left: 3rem;">
                    <i class="fas fa-calculator"></i>
