...
@section('page-title', 'Investment Calculator')
@section('page-description', 'Calculate your investment returns and plan your financial future')
...
<div class="calculator-wrapper">
        <div class="form-wrapper">
            <div class="form-container">
                <h2><i class="fas fa-edit me-2"></i>Enter Your Investment Details</h2>
        ...
        <div class="results-wrapper">
            <div class="results-section investment-results">
                <h3><i class="fas fa-chart-line me-2"></i>Your Results</h3>
                <div id="your-results">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            $('#current_age, #retirement_age, #current_investment, #monthly_contribution, #annual_return').on('input', function() {
                if (validateAges()) {
                    ...
                    clearTimeout(window.investmentCalcTimeout);
                    window.investmentCalcTimeout = setTimeout(calculateInvestment, 500);
                }
            });
